...
if select_page == 'Predictions':
    ...
    if select_frequency == 'Last 14 days':
        ...
        if select_geo_regions == 'Police District':
            ...
            select_pol_district = st.multiselect('Select Police District(s)', police_district,default= ['District A'])
            ...
            if len(df_14_days_1) != 0:
                fig = px.scatter(df_14_days_1, x='incident_date_only', y='no_of_crimes',
                                 color=df_14_days_1['police_district'], height=500,
                                 width=760)
            else:
                fig = px.scatter(a, x='incident_date_only', y='no_of_crimes',
                                 color=a['police_district'], height=500, width=760)
            ...
            select_inc_type = st.selectbox('Select type of Incident', inc_type)
            ...
            select_council_district = st.multiselect('Select Council District(s)', council_district, default= ['DELAWARE'])
            ...
            if len(df_14_days_1) != 0:
                ...
                fig = px.scatter(b, x='incident_date_only', y='no_of_crimes',
                                 color=b['council_district'], height=500, width=760)
            ...
            select_neighborhood = st.multiselect('Select Neighborhood', neighborhood,default= ['Central Park'])
            ...
            if len(df_14_days_1) != 0:
                ...
                fig = px.scatter(c, x='incident_date_only', y='no_of_crimes',
                                 color=c['neighborhood'], height=500, width=760)
            fig.update_traces(mode='lines')
            fig.update_layout(
                title={
                    'text': "Past trend in the last 14 days",
        ...
        if select_geo_regions == 'Police District':
            ...
            council_district = list(b['council_district'].unique())
            select_pol_district = st.multiselect('Select Council District(s)', council_district, default= ['DELAWARE'])
